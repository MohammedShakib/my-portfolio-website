...
export const featuredProjects = [
  ...
  },
  {
    ...
    tags: ["React.js", "Express.js", "Redis", "Supabase", "Railway"],
    image: "/assets/projects/campus-twin.png",
...
export const professionalCertifications = [
  {
    ...
    logo: "/assets/logos/cognitive-class.png",
    credentialId: "",
    credentialUrl: "",
    certificateFile: "",
  ...
  {
    title: "Introduction to Claude Work",
    issuer: "Anthropic",
    issued: "May 2026",
    ...
    credentialUrl: "",
    certificateFile: "",
    skills: ["Claude", "AI Workflows", "Productivity"],
    featured: false,
  },
  {
    ...
    credentialUrl: "",
    certificateFile: "",
    skills: ["Claude Code", "AI Development", "Developer Tools"],
    featured: true,
  },
  {
    ...
    credentialUrl: "",
    certificateFile: "",
    skills: ["Claude Code", "Code Assistance", "AI Workflows"],
    featured: false,
  },
  {
    title: "Claude 101",
    ...
    credentialUrl: "",
    certificateFile: "",
    skills: ["Claude", "Prompting", "Generative AI"],
    featured: false,
  },
  {
    ...
    credentialUrl: "",
    certificateFile: "",
    skills: ["AI Safety", "Model Evaluation", "Generative AI"],
    featured: true,
  },
  {
    ...
    logo: "/assets/logos/grameenphone.svg",
    credentialId: "",
    credentialUrl: "",
    certificateFile: "",
    skills: ["Communication", "AI Tools", "Professional Writing"],
    featured: true,
  },
  {
    ...
    credentialUrl: "",
    certificateFile: "",
    skills: ["Career Planning", "AI Tools", "Professional Growth"],
    featured: false,
  },
];
