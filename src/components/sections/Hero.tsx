        ...
        <div className="grid grid-cols-1 gap-10 md:gap-8 lg:grid-cols-2 lg:gap-8 items-center lg:items-end">
          ...
          <div className="relative flex flex-col items-center justify-center lg:items-end lg:justify-end lg:self-end">
            <div className="relative h-[266px] w-full max-w-[282px] sm:h-[280px] sm:max-w-[300px] md:h-[580px] md:max-w-[520px] lg:h-[650px] lg:max-w-[610px]">
              ...
              <div className="absolute inset-x-[-24%] top-[-22px] z-10 h-24 bg-gradient-to-b from-[#111111] via-[#111111]/78 to-transparent md:hidden"></div>
              ...
              <div className="w-full h-full relative overflow-visible">
                ...
                <Image
                  ...
                  style={{
                    maskImage: "linear-gradient(to bottom, transparent 0%, rgba(0,0,0,.25) 8%, #000 18%, #000 66%, rgba(0,0,0,.72) 80%, rgba(0,0,0,.25) 91%, transparent 100%)",
                    WebkitMaskImage: "linear-gradient(to bottom, transparent 0%, rgba(0,0,0,.25) 8%, #000 18%, #000 66%, rgba(0,0,0,.72) 80%, rgba(0,0,0,.25) 91%, transparent 100%)",
                  }}
                  preload
                />
              </div>
