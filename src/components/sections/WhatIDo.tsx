...
export default function WhatIDo() {
  return (
    <section className="py-16 md:py-24 bg-background-light text-primary relative">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="no-scrollbar flex snap-x snap-mandatory gap-4 overflow-x-auto pb-2 md:grid md:grid-cols-2 md:gap-6 md:overflow-visible md:pb-0 lg:grid-cols-4 lg:gap-8">
          {whatIDo.map((item, index) => {
            const Icon = item.icon;
            return (
              <div 
                key={index} 
                className="group flex min-h-[230px] w-[84vw] shrink-0 snap-start flex-col items-start p-5 bg-white/60 hover:bg-white transition-colors duration-300 border border-primary/10 hover:border-accent/45 md:min-h-[310px] md:w-auto md:p-8"
              >
